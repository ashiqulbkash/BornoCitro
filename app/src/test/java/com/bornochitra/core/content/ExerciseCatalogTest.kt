...
class ExerciseCatalogTest {
    ...
    fun `english capital letters carry the right characters in alphabet order, with no matra`() {
        ...
        assertEquals("ABCDEFGHIJKLMNOPQRSTUVWX", letters.joinToString("") { it.title })
        letters.forEach { letter ->
    ...
    fun `every exercise has the stroke count of its real letter or shape`() {
        val expected = mapOf(
            ...
            "english-capital-a" to 3,
            "english-capital-b" to 3,
            "english-capital-c" to 2,
            "english-capital-d" to 3,
            "english-capital-e" to 4,
            "english-capital-f" to 3,
            "english-capital-g" to 2,
            "english-capital-h" to 3,
            "english-capital-i" to 1,
            "english-capital-j" to 1,
            "english-capital-k" to 3,
            "english-capital-l" to 1,
            "english-capital-m" to 4,
            "english-capital-n" to 3,
            "english-capital-o" to 2,
            ...
            "english-capital-v" to 2,
            "english-capital-w" to 2,
