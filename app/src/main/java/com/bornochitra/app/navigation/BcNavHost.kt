...
/** Screens with the navigation drawer: its menu icon and swipe from the edge. */
private val DRAWER_ROUTES = setOf(BcDestination.Home.route)
...
fun BcNavHost(
    ...
    ModalNavigationDrawer(
        ...
        drawerContent = { DrawerContent(state = drawerUiState, onEvent = drawerViewModel::onEvent) },
        modifier = modifier,
        gesturesEnabled = currentRoute in DRAWER_ROUTES,
    ) {
        NavHost(
