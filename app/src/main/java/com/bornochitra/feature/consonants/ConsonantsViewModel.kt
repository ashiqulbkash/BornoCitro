...
/** The 39 consonants, each with how far the child has got with it (plan.md Step 1). */
@HiltViewModel
class ConsonantsViewModel @Inject constructor(
    ...
    val uiState: StateFlow<CategoryGridState> = observeCategoryGrid(ExerciseType.CONSONANT, exerciseRepository, progressRepository)
        .stateIn(
