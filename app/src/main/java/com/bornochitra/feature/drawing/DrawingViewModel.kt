...
data class DrawingState(
    val exercises: List<DrawingListItem> = emptyList(),
)
...
class DrawingViewModel @Inject constructor(
    ...
    val uiState: StateFlow<DrawingState> = exerciseRepository.observeExercises(ExerciseType.DRAWING)
